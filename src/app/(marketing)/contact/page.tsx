...
const contactChannels = [
  ...
  },
  {
    ...
    value: "billing@shiftproof.app",
    sub: "For refunds, invoice, plan changes",
    href: "mailto:billing@shiftproof.app",
  ...
  },
  {
    ...
    value: "legal@shiftproof.app",
    sub: "Privacy, data requests, ToS queries",
    href: "mailto:legal@shiftproof.app",
    color: "text-accent-500",
    bg: "bg-accent-50",
    border: "border-accent-100",
  },
  {
    ...
    value: "hello@shiftproof.app",
    sub: "Media kit, co-marketing, integrations",
    href: "mailto:hello@shiftproof.app",
    color: "text-accent-500",
    bg: "bg-accent-50",
    border: "border-accent-100",
  },
