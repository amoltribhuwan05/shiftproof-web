...
export default function Footer() {
  ...
  const companyLinks = [
    ...
    { label: "Blog", href: "#" },
    { label: "Careers", href: "#" },
    { label: "Contact", href: "mailto:support@shiftproof.app" },
  ];
  const supportLinks = [
      ...
      <div className="border-b border-slate-800 bg-gradient-to-r from-violet-900 to-indigo-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white">
            Your PGs, managed. Starting tonight.
          </h2>
          <p className="mt-4 text-violet-200 text-base sm:text-lg">
            14-day free trial. No credit card. Free forever for tenants.
          </p>

          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="/#pricing"
              className="inline-flex items-center gap-2 rounded-full bg-orange-500 px-7 py-3.5 text-sm font-bold text-white hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/30"
            >
              Start Free Trial
            ...
            <a
              href="#"
              className="flex items-center gap-3 rounded-2xl bg-white/10 border border-white/20 px-6 py-3.5 hover:bg-white/20 transition-colors"
            >
              ...
              <div className="flex flex-col text-left">
                <span className="text-[10px] font-medium text-violet-300 leading-none">Get it on</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-6 flex gap-3">
              {[
                { label: "X (Twitter)", icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.838L2.1 2.25h6.865l4.258 5.646L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" /></svg> },
                { label: "Instagram",   icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="0.5" fill="currentColor" stroke="none"/></svg> },
                { label: "LinkedIn",    icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2zm2-3a2 2 0 110-4 2 2 0 010 4z"/></svg> },
              ].map((s) => (
                <a
                  key={s.label}
                  href="#"
